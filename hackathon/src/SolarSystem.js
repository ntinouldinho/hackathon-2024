...
const SolarSystem = () => {
  ...
  useEffect(() => {
    ...
    if (flag) {
      ...
      const mercury = new Planet(2, 15, "textures/mercury.jpeg", "Mercury");
      const mercuryMesh = mercury.getMesh();
      let mercurySystem = new THREE.Group();
      mercurySystem.add(mercuryMesh);

      const venus = new Planet(3, -25, "textures/venus.jpeg", "Venus");
      ...
      const mars = new Planet(3, -50, "textures/mars.jpeg", "Mars");
      const marsMesh = mars.getMesh();
      let marsSystem = new THREE.Group();
      marsSystem.add(marsMesh);

      const jupiter = new Planet(5, 60, "textures/jupiter.jpeg", "Jupiter");
      const jupiterMesh = jupiter.getMesh();
      let jupiterSystem = new THREE.Group();
      jupiterSystem.add(jupiterMesh);

      const saturn = new Planet(6, -66, "textures/saturn.jpeg", "Saturn");
      ...
      const neptune = new Planet(5, -80, "textures/neptune.jpeg", "Neptune");
